...
## Жанр истории:
{story.story_theme or "Приключенческая сказка"}

## Интересы ребенка
{story.story_extra or "Не указаны"}

## Тема, которую нужно раскрыть в истории:
{story.story_message or "Дружба и взаимопомощь"}

## Язык
Строго английский. Абсолтно все, что ты мне вернешь должно быть на английском языке
...
Используя предоставленную информацию, создайте увлекательную историю в выбранном жанре, где главным героем будет описанный мультяшный персонаж. История должна:
...
6. Включать шесть специальных отметок для вставки иллюстраций в ключевых моментах рассказа: [ИЛЛЮСТРАЦИЯ_1], [ИЛЛЮСТРАЦИЯ_2], [ИЛЛЮСТРАЦИЯ_3], [ИЛЛЮСТРАЦИЯ_4], [ИЛЛЮСТРАЦИЯ_5], [ИЛЛЮСТРАЦИЯ_6]. Эти отметки должны быть размещены в тексте на отдельной строке в наиболее значимых и зрелищных моментах истории.
...
9. Don't use any words that could trigger Leonardo AIs censorship policy
10. Mode CHILD
...
## Структура ответа
1. Название истории (яркое и соответствующее сюжету)
...
## ВАЖНО
Сначала проанализируй текст и если текст содержит запрещенные, нелегальные слова, останови генерацию и выведи сообщение об ошибке. Если ошибок нет, сразу же начинай генерацию рассказа"""
