...
## Структура ответа
1. Название истории (яркое и соответствующее сюжету) (story_title [the tag is strictly in english])
2. Сама история (с отметками для иллюстраций в ключевых моментах) (story_body [the tag is strictly in english])
3. Послесловие в одном предлложении о том, какие ценности или уроки представлены в истории (in {story.story_language})
4. Промты для генерации иллюстраций - 6 детальных промтов на английском языке для генерации иллюстраций.  (illustration_prompts, listed as n1, n2, n3, n4, n5, n6 [the tags are strictly in english])
