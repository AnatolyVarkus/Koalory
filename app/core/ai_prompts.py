...
4. Промты для генерации иллюстраций - 6 детальных промтов на английском языке для генерации иллюстраций.  (illustration_prompts, listed as n1, n2, n3, n4, n5, n6)
# Формат финального ответа (всегда на английском):

- **story_title:** Название истории
- **story_body:** Текст истории с тегами [ILLUSTRATION_1] … [ILLUSTRATION_6]
- **afterword:** Одно предложение с моралью или уроком
